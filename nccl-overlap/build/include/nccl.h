...
void getNCCLRing(ncclComm_t* comm, int *ring, int& ringLength, int& nChannels);
...
ncclResult_t ncclAllReduceOverlapMatMul(const void* m1buff, void* m2buff, void* m1m2buff,
    void* syncGlobalMem, size_t count, int M, int N, int K, int realChunkCols, int outerIteration,
    ncclDataType_t datatype, ncclRedOp_t op, ncclComm* comm, cudaStream_t stream);

ncclResult_t ncclAllReduceMatrix(void* m1m2buff, size_t count, int M, int N, int realChunkCols,
    ncclDataType_t datatype, ncclRedOp_t op, ncclComm* comm, cudaStream_t stream);

ncclResult_t ncclAllReduceAdam(const void* sendbuff, void* recvbuff, void* weightbuff, size_t count, void* alpha,
    void* firstMomentBuff, void* secondMomentBuff, void* beta1Buff, void* beta2Buff, const int epoch, 
    ncclDataType_t datatype, ncclRedOp_t op, ncclComm* comm, cudaStream_t stream);
ncclResult_t pncclAllReduce(const void* sendbuff, void* recvbuff, size_t count,
    ncclDataType_t datatype, ncclRedOp_t op, ncclComm_t comm, cudaStream_t stream);

ncclResult_t ncclAllReduceScatteredWeights(const void* sendbuff, void** weightbuff, size_t nbuff, size_t* counts, size_t total,  void* alpha,
                                    ncclDataType_t datatype, ncclRedOp_t op, ncclComm* comm, cudaStream_t stream);

ncclResult_t ncclAllReduceScatteredGradWeights(const void** sendbuff, void** weightbuff, size_t nbuff, size_t* counts, size_t total,  void* alpha,
                                    ncclDataType_t datatype, ncclRedOp_t op, ncclComm* comm, cudaStream_t stream);
